...
<div id="pageTitle">UPDATE GAMEPLAY RECORD</div>

<div id="form">
    <form action="gameplay_update_processing.jsp" method="post">
        <jsp:useBean id="G" class="arcadeRecord.gameplay" scope="session" />

        <section>
            <h3> Gameplay ID: <% out.println(G.selectedID); %> </h3>
        </section>
        <section>
